...
public class MainActivity extends AppCompatActivity {
    ...
    private void setMusicPlayerComponents() {
      ...
      try {
        ...
        AssetFileDescriptor afd = getAssets().openFd("juzamma.mp3");
    ...
    private boolean toggleButtonColor(ImageButton bt) {
      ...
      if (selected != null) { // selected
        bt.setColorFilter(getResources().getColor(R.color.colorLighBlue), PorterDuff.Mode.SRC_ATOP);
